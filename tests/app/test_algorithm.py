...
def create_test_data(session):
    ...
    preferences1 = MatchingPreferences(user_id=1, gender_preference=Gender.male, min_age=20, max_age=30)
    ...
    preferences2 = MatchingPreferences(user_id=2, gender_preference=Gender.female, min_age=5, max_age=5)
...
def test_no_matches_by_gender(test_session):
    ...
    preferences3 = MatchingPreferences(user_id=3, gender_preference=Gender.non_binary, min_age=5, max_age=5)
...
def test_no_matches_by_age(test_session):
    ...
    preferences3 = MatchingPreferences(user_id=4, gender_preference=Gender.female, min_age=1, max_age=1)
    user3.profile = profile3
    user3.matching_preferences = preferences3
...
def test_blocked_users(test_session):
    ...
    preferences1 = MatchingPreferences(user_id=1, gender_preference=Gender.male, min_age=5, max_age=5)
    user1.profile = profile1
    user1.matching_preferences = preferences1
